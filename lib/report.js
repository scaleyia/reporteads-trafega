...
export function buildHtml(cfg) {
  ...
  const titulo = cfg.tituloPeriodo ? `Resumo Semanal &middot; ${cfg.tituloPeriodo}` : `Resumo da Conta &middot; ${cfg.mes} / ${cfg.ano}`;
  const short = cfg.tituloPeriodo ? `${cfg.cliente} &middot; ${cfg.tituloPeriodo}` : `${cfg.cliente} &middot; ${cfg.mes} / ${cfg.ano}`;
