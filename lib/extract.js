...
const SYSTEM = `Você extrai dados de prints do Google Ads para o relatório mensal da agência Tráfega Mídia (clientes de diversos segmentos). Leia os DOIS prints e devolva os números EXATAMENTE como aparecem.
